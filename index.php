			  ...
			  <li class="nav-item active">
			   ...
			   <li class="nav-item dropdown">
					...
					<ul class="dropdown-menu" aria-labelledby="dropdown03">
						...
						<li><a class="dropdown-item" href="signup.php">Doctor </a></li>
			...
			<div class="col-lg-6 col-md-12 col-xl-7">
				<div class="block">
					...
					<div class="btn-container ">
						<a href="login.php" target="_blank" class="btn btn-main-2 btn-icon btn-round-full">Login Now <i class="icofont-simple-right ml-2  "></i></a>
					</div>
				</div>
			</div>
		</div>
