		...
		<div class="row">
			<div class="col-lg-3 col-md-6 col-sm-6">
				<div class="team-block mb-5 mb-lg-0">
					...
					<div class="content">
						<h4 class="mt-4 mb-0"><a href="doctor-single.html">Anoop Menon</a></h4>
			...
			<div class="col-lg-3 col-md-6 col-sm-6">
				<div class="team-block mb-5 mb-lg-0">
					...
					<div class="content">
						<h4 class="mt-4 mb-0"><a href="doctor-single.html">Radha Devi</a></h4>
						<p>Gynaecology</p>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-3 col-md-6 col-sm-6">
				<div class="team-block">
					...
					<div class="content">
						<h4 class="mt-4 mb-0"><a href="doctor-single.html">Joesph</a></h4>
