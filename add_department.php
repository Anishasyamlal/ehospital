  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-6">
           ...
           <h2 class="mb-2 title-color" style="color:white">Add Department</h2>
               <form id="#" class="appoinment-form" method="post" >
                    <table><tr>
                          <th><label>Name Of Department</label></th>
						  <td>   <input name="name" id="" type="text" class="form-control" placeholder="Department Name"></td></tr>
                    <tr><th colspan=2><button name="submit" class="btn btn-primary">Save</button></th></tr>
						</table>       
               </form>
           </div>
      </div>
