...
if(isset($_POST['submit']))
{
    ...
    $rply=$_POST['rply'];
mysqli_query($conn,"update chat_to set reply='$rply',status=1 where patient_id='$id'");
header("location:chat_reply.php");
}
?>
<!DOCTYPE html>
<html lang="zxx">
                    ...
                    <table class="table">
					  ...
					  <tbody>
						  ...
						  <tr>
							  ...
							  <td><input type="text" name="rply" placeholder="Add reply"></td>
